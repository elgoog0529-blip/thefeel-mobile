...
const CACHE = 'thefeel-mobile-1787298849801';
const ASSETS = [
  './',
  './index.html',
...
self.addEventListener('fetch', e => {
  ...
  // v2.48.1: .enc 추가 — 사용자 옛 데이터 잔존 fix
  const isFresh = /\.(json|enc|html)(\?|$)/i.test(url.pathname) || url.pathname === '/' || url.pathname.endsWith('/');
